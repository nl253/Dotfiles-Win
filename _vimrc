...
sil cal s:register_ftype(['*.pest'], 'pest')
sil cal s:register_ftype(['*.grammar', 'grammar', '*.{peg,bnf,ebnf}'], 'grammar')
sil cal s:register_ftype(['.{space,e}macs'], 'lisp')
sil cal s:register_ftype(['*.gv'], 'dot')
sil cal s:register_ftype(['*.toml'], 'cfg')
sil cal s:register_ftype(['*{ignore,conf}*'], 'config')
sil cal s:register_ftype(['yarn.lock'], 'yaml')
sil cal s:register_ftype(['*.puml'], 'plantuml')
sil cal s:register_ftype(['.tern-{config,project}', '.{markdown,html,es,style}lintrc', '.{babel,jsbeautify}rc' ,'*.lock', '.tsconfig'], 'json')
sil cal s:register_ftype(['*.{twig,nunj,njk,hbs}'], 'htmldjango')
sil cal s:register_ftype(['*.*css'], 'css')

sil cal s:force_ftype(['*.v', '*.coq'], 'coq')
